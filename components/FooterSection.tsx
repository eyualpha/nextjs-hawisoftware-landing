    ...
    <section className="py-10 bg-red-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex md:items-center flex-col md:flex-row justify-between w-full">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8 md:w-1/2 w-full ease-in-out intersect:motion-preset-slide-up motion-delay-200">
            ...
            <p className="text-base leading-relaxed text-gray-600 mt-7">
              We are powered by highly skilled professionals and developers, and
              equipped with the latest managerial and IT tools and works round
              the-clock to assure the timely delivery of your applications with
              the highest quality.
            </p>
            ...
            <ul className="flex items-center space-x-3 mt-9">
              <li>
                <a
                  href="#"
                  title=""
                  className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-red-400 focus:bg-red-400"
                >
                  <svg
                    className="w-4 h-4"
        ...
        <p className="text-sm text-center text-gray-600">
          © Copyright 2025, All Rights Reserved by Hawi Software Solutions
        </p>
      </div>
    </section>
  );
